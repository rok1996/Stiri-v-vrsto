...
Igra3::Igra3(): i1(NULL), i2(NULL), polje(NULL), naVrsti(NULL), l(false){}
Igra3::Igra3(Igralec *i1, Igralec *i2){
  this->i1 = i1;
  this->i2 = i2;
  this->naVrsti = i1;
  this->l = false;
...
bool Igra3::preveriZmaga(int x, int y, int p){
  int v=0, i = x, j = y;
  bool z = false;
  //vodoravno
...
Igralec* Igra3::getNaVrsti(){
  return naVrsti;
}

void Igra3::setNaVrsti(Igralec *n){
  naVrsti = n;
}

int* Igra3::potez(int y, int p){
